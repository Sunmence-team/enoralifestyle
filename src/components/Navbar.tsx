      ...
      >
        ...
        <div className="flex flex-col items-center justify-start flex-1 gap-6 mt-10">
          ...
          <Link
            to="/appointment"
            onClick={handleLinkClick}
            className="bg-(--primary-color) hover:opacity-90 active:scale-95 text-white py-3 px-5 rounded-full text-sm font-medium transition-all duration-200 cursor-pointer mt-6"
          >
            Book Appointment
          </Link>
        </div>
