    ...
    >
      ...
      <div className="bg-white border border-black/5 rounded-3xl shadow-sm p-5 flex flex-col items-center text-center relative z-10 w-full">
        ...
        <div className="flex justify-between mt-10 w-full">
          ...
          <button className="w-1/2 flex items-center justify-center gap-1 bg-transparent border border-gray-400 text-gray-400 font-medium px-3 py-3 rounded-sm">
            <span className="h-4 w-16 bg-gray-300 rounded"></span>
            <FiArrowRight className="w-4 h-4 ml-1 rounded" />
          </button>
        </div>
      </div>
    </div>
