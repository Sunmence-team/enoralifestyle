...
const ServiceCard = (item: ServiceCardProps) => {
  ...
  return (
    <>
      <div className="bg-white rounded-3xl pb-5 shadow-sm hover:shadow-md transition-all duration-300  flex flex-col items-center text-start md:h-[520px] h-[530px]">
        ...
        <div className="px-5 pt-5 w-full flex flex-col justify-between h-[calc(100%-250px)]">
          <div className="">
            ...
            <p className="text-gray-600 mt-2 text-sm font-[inter]! line-clamp-3">
              {item.description}
            </p>
          ...
          <div className="flex justify-start gap-3">
            ...
            >
              View Details
              <FiArrowRight className="md:size-4 size-3 ml-1 -rotate-45" />
            </button>
          </div>
        </div>
      </div>
