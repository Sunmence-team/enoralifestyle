...
const Ebooks : React.FC = () => {
    ...
    return (
        <>
            <SEO
                title="Ebooks"
                description="Your Guides to Ultimate Relaxation and Health, expert Insights on Spa & Self-Care"
                imageUrl={assets.ebookbg}
                url="/ebooks"
            />
            <div className="">
                <HeroSection
